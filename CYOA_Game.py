  ...
  while userInput not in actions:
    ...
    if userInput == "fight":
      if weapon:
        ...
        print("The goul-like creature has killed you. Try using a weapon next time!")
      quit()
    elif userInput == "flee":
      showSkeletons()
    else:
...
def showSkeletons():
  ...
  while userInput not in directions:
    ...
    userInput = input()
    if userInput == "left":
      print("You find that this door opens into a wall. You open some of the drywall to discover a knife. Nice!")
      weapon = True
...
def hauntedRoom():
  ...
  while userInput not in directions:
    ...
    if userInput == "right":
      if weapon:
        print("Multiple goul-like creatures start emerging as you enter the room. You fought vigilantly with your knife and won! Congrats!")
      else:
        print("Multiple goul-like creatures start emerging as you enter the room. You are killed. Try using a weapon next time!")
      quit()
    elif userInput == "left":
